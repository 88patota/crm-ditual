#!/usr/bin/env python3
"""
Test script to verify the calculate-simplified endpoint is working properly
"""
import requests
import json

def test_calculate_simplified_endpoint():
    """Test the calculate-simplified budget endpoint"""
    ...
    # Test data with CORRECT field names (no quantity required)
    test_data = {
    ...
    print("Testing calculate-simplified endpoint...")
    print(f"URL: {url}")
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if response.status_code == 500:
                print("❌ CONFIRMED: 500 Internal Server Error still occurring")
